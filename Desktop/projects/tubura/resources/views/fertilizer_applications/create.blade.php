...
@section('path')
<div class="title">
   <h4>New Fertilizer Application</h4>
</div>
<nav aria-label="breadcrumb" role="navigation">
   <ol class="breadcrumb">
   <li class="breadcrumb-item"><a href="http://tubura.test/dashboard">Home</a></li>
      <li class="breadcrumb-item active" aria-current="page">New Fertilizer Application</li>
   </ol>
</nav>
@endsection
...
<form action="{{route('fertilizer-applications.store')}}" method="POST" novalidate>
   @csrf
