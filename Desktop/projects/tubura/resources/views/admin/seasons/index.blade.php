...
<a style="margin-bottom:20px" href="{{route('seasons.create')}}" class="btn btn-success"><i class="icon-copy fa fa-plus" aria-hidden="true"></i>New</a>
   <table class="data-table table stripe hover nowrap">
    ...
    <td>
        <div class="dropdown">
            ...
            <a class="dropdown-item" href="{{route('seasons.edit',['season'=>$season] )}}"><i class="dw dw-edit2"></i> Edit</a>

            <a class="dropdown-item"  href="{{route('seasons.show',['season'=>$season] )}}"><i class="dw dw-eye"></i> Show</a>
            <a class="dropdown-item"  href="javascript:void(0)" onclick="event.preventDefault();
            document.getElementById('delete-season-{{$season->id}}').submit();"> <i class="dw dw-eye"></i> Delete</a>
