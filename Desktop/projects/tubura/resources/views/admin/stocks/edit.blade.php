...
<nav aria-label="breadcrumb" role="navigation">
    ...
    <li class="breadcrumb-item"><a href="{{ url()->previous() }}">Stocks</a></li>
    ...
    <div class="form-group row">
        ...
        <select class="js-example-basic-single form-control" style="width:100%" name="season_id" id="season_id">
            ...
            <option value="{{$season->id}}"
                @if($stock->season_id == old('season_id', $season->id))
                selected="selected"
                @endif
            >{{$season->start}}</option>
    ...
    <div class="form-group row">
        ...
        <select class="js-example-basic-single form-control" style="width:100%" name="fertilizer_id" id="fertilizer_id">
            ...
            <option value="{{$fertilizer->id}}"
                @if($stock->fertilizer_id == old('fertilizer_id', $fertilizer->id))
                selected="selected"
                @endif
    ...
    <div class="form-group row">
        ...
        <select class="js-example-basic-single form-control" style="width:100%" name="seed_id" id="seed_id">
            ...
            <option value="{{$seed->id}}"
                @if($stock->seed_id == old('seed_id', $seed->id))
                selected="selected"
                @endif
            >{{$seed->name}}</option>
        ...
        <div class="col-sm-12 col-md-10">
                <input class="form-control Integer"  type="number"  name="initial_amount" id="initial_amount" value="{{old('initial_amount',$stock->initial_amount)}}"
                        required="required"
                >
        ...
        <div class="col-sm-12 col-md-10">
                <input class="form-control Integer"  type="number"  name="current_amount" id="current_amount" value="{{old('current_amount',$stock->current_amount)}}"
                        required="required"
                >
